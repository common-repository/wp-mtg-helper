=== Plugin Name ===
Contributors: backseatsurfer, surmem
...
Thank you [Dave Astels](http://blog.daveastels.com/) & [Blake Stearman](http://surrealmemoir.com/) for the latest updates (did I forget someone?). Without those guys there would be no more upates for the plugin. Thank you guys very much!

[You find the old change log here](http://www.backseatsurfer.de/wp-mtg-helper/#releases)

= 1.2.7 = 
* Includes fix for split cards in deck lists.
* Fixes bug introduced in 1.2.6 which dropped some card quantities from deck lists.
